...
function Input_Decimal (dot) {
    ...
    //doesn't' cause bugs in the operator
...
function Handle_Operator(Next_Operator) {
    ...
    //displayed on the  screen to a number and then tore the result in
...
//this function upadte the screen with contens of Display_value
...
keys.addEventListener('click', (event) => {
    //the target variable is an object that repwrsents the element
    //that was clicked
    const {target} = event;
